...
--
-- The following script bindings have no default keys and must be added to input.conf:
--
--   script-binding memo-history  Open the recent files menu
--   script-binding memo-search   Open the search prompt / palette
--   script-binding memo-last     Open the most recently played file (skips current)
--   script-binding memo-log      Manually add the current file to history
--   script-binding memo-next     Navigate to older entries (pagination)
--   script-binding memo-prev     Navigate to newer entries (pagination)
--
-- Example input.conf entries:
--   h script-binding memo-history
--   Ctrl+h script-binding memo-search
--   Alt+h script-binding memo-last
